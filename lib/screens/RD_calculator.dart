...
class RD_Calculator extends StatefulWidget {
  ...
  @override
  State<RD_Calculator> createState() => RD_calculatorState();
}

class RD_calculatorState extends State<RD_Calculator> {
  ...
  void updateValues() {
    InvestedAmount = calculateTotalInvestedInRD(MonthlyInvested, TimePeriod);
    TotalValue = calculateFinalMaturity(MonthlyInvested, ReturnRate, TimePeriod, 4);
                              ...
                              children: [
                                ...
                                Builder(
                                  builder: (context) {
                                    updateValues();
                                    return Text(
                                      '₹${NumberFormat('#,##,###').format(EstReturn.ceil())}',
                                      style: TextStyle(fontSize: 18),
                                    );
                                  }
                                )
                              ...
                              children: [
                                ...
                                Builder(
                                  builder: (context) {
                                    updateValues();
                                    return Text(
                                      '₹${NumberFormat('#,##,###').format(TotalValue.ceil())}',
                                      style: TextStyle(fontSize: 18),
                                    );
                                  },
                                ),
